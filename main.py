...
map_obj_3 = Map_Masks(pygame.image.load('map_3_obj.png').convert_alpha())
map_obj_4 = Map_Masks(pygame.image.load('map_4_obj.png').convert_alpha())
    ...
    if enemy_hit.health <= 0:
        ...
        for i in range(13):
            if (i % 2) != 0 and i < 8:
                ...
                enemy_hit.die()
        print("enemy_hit.level", enemy_hit.level)
